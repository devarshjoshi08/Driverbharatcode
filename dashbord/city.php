        ...
        <div class="maindiv">
            ...
            <table id="table">
                ...
                <tbody>
                    <?php
                $id = $_GET['id'];
                $query = " SELECT * FROM all_cities WHERE state_code = $id";
                ...
                <tr>
                    ...
                    if ($row['role'] == 1) { ?>
                        <button class="add">
                        <a href="deletupdate/cityactive.php?id=<?php echo $row['city_code'];?>">active</a>
                        </button>
                    
                
                    <?php } else { ?>
                        <button class="remove">
                        <a href="deletupdate/cityactive.php?id=<?php echo $row['city_code'];?>">Inactive</a>
                        </button>
                    <?php } ?>
                    </td>
                </tr>
