...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="complaint.php" class="nav__link active">
                        <i class='bx bx-mail-send nav__icon'></i>
    ...
    <table id="table">
            ...
            <tbody>
                <?php
                $query = " SELECT * FROM complaint_db";
                ...
                if (mysqli_num_rows($query_run) > 0) {
                    foreach($query_run as $row) {
                        ?>
                            <tr>
                                ...
                                <td><?= $row['complaint']; ?></td>
                                <td><?= $row['cmp_date']; ?></td>
                                <td><button class="add"><a href="user/complaintreply.php?id=<?php echo $row['cmp_id']; ?>">Reply</a></button></td>
                            </tr>
                        <?php
                    }
                } 
                    ...
                    ?>
                        <tr>
                            <td collspan="5">No data found</td>
                        </tr>
                    <?php  
                }
                    ?>
